...
const english = {
  ...
  landingInstallDesktop: "Chrome or Edge on a computer",
  landingInstallDesktopStepOne: "Click the install icon at the right end of the address bar.",
  landingInstallDesktopStepTwo: "In Edge, you can also open ⋯, choose Apps, then Install this site as an app.",
...
const russian: Copy = {
  ...
  landingInstallDesktop: "Chrome или Edge на компьютере",
  landingInstallDesktopStepOne: "Нажмите значок установки в правой части адресной строки.",
  landingInstallDesktopStepTwo: "В Edge также можно открыть меню ⋯, выбрать «Приложения», затем «Установить этот сайт как приложение».",
