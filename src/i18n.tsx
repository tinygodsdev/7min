...
const english = {
  ...
  editorAdd: "Add",
  editorAudio: "Audio",
  editorAudioTitle: "Signals and voice",
  editorAudioHelp: "Set a clear signal volume and choose whether the next exercise is announced during each break.",
  editorSoundEnabled: "Workout audio",
  editorSoundEnabledHelp: "Signals, countdown ticks and voice.",
  editorSignalVolume: "Signal volume",
  editorSignalVolumeHelp: "Loud is the default for phone speakers.",
  editorVolumeNormal: "Normal",
  editorVolumeLoud: "Loud",
  editorVolumeExtraLoud: "Extra loud",
  editorVoiceEnabled: "Voice announcements",
  editorVoiceEnabledHelp: "English exercise names, played before each interval.",
  editorVoiceVolume: "Voice volume",
  editorVoiceVolumeHelp: "Adjusted independently from interval signals.",
  editorPreviewSound: "Play signal",
  editorPreviewVoice: "Play voice",
  ...
  workoutOf: "of",
  workoutBreak: "Break",
  workoutPrepare: "Get ready",
  workoutNow: "Now",
  workoutFirst: "First",
  workoutNext: "Next",
  workoutGetReady: "Get ready for the next exercise.",
  workoutStartingSoon: "The first interval starts in a moment.",
  workoutSeconds: "sec",
  workoutPause: "Pause",
  ...
  landingSignalsBody: "Exercise and rest use different clear signals. An English voice names the next movement during each break. Both can be configured.",
  ...
  landingInstallTitle: "Install the app",
  landingInstallIntro: "Choose your browser. Menu names can vary slightly by version.",
  landingInstallRecommended: "Your browser",
  landingInstallIOSSafari: "Safari on iPhone or iPad",
  landingInstallIOSStepOne: "Open this page in Safari.",
  landingInstallIOSStepTwo: "Tap Share in the toolbar. Scroll down and choose Add to Home Screen.",
  landingInstallIOSStepThree: "Turn on Open as Web App, then tap Add.",
  landingInstallAndroidChrome: "Chrome on Android",
  landingInstallChromeStepOne: "Tap ⋮ beside the address bar.",
  landingInstallChromeStepTwo: "Choose Add to home screen, then Install.",
  landingInstallAndroidFirefox: "Firefox on Android",
  landingInstallFirefoxStepOne: "Tap ⋮ in the browser toolbar.",
  landingInstallFirefoxStepTwo: "Choose Install, then add the icon to your home screen.",
  landingInstallDesktopChromium: "Chrome or Edge on a computer",
  landingInstallDesktopChromiumStepOne: "Click the install icon at the right end of the address bar.",
  landingInstallDesktopChromiumStepTwo: "In Edge, open ⋯, choose Apps, then Install this site as an app.",
  landingInstallDesktopFirefox: "Firefox or Zen on a computer",
  landingInstallDesktopFirefoxStepOne: "In Firefox 143 or later on Windows, click the web app icon in the address bar.",
  landingInstallDesktopFirefoxStepTwo: "Zen and Firefox on macOS or Linux may not offer installation. Open this page in Chrome or Edge, or continue in the browser.",
  landingOpenWithoutInstall: "Open without installing",
  createdBy: "Created by",
  repositoryLinkLabel: "Source code on GitHub",
  ...
  privacyLocalBody: "Your exercise order, enabled exercises, audio preferences, language and workout history are stored in your browser. The browser also caches app files so the workout can work offline.",
...
const russian: Copy = {
  ...
  editorReset: "Сбросить программу",
  ...
  editorAdd: "Добавить",
  editorAudio: "Звук",
  editorAudioTitle: "Сигналы и голос",
  editorAudioHelp: "Выберите громкость сигналов и решите, нужно ли называть следующее упражнение во время перерыва.",
  editorSoundEnabled: "Звук тренировки",
  editorSoundEnabledHelp: "Сигналы, отсчёт и голос.",
  editorSignalVolume: "Громкость сигналов",
  editorSignalVolumeHelp: "Для динамика телефона по умолчанию выбрана высокая громкость.",
  editorVolumeNormal: "Обычно",
  editorVolumeLoud: "Громко",
  editorVolumeExtraLoud: "Очень громко",
  editorVoiceEnabled: "Голосовые подсказки",
  editorVoiceEnabledHelp: "Английские названия упражнений перед каждым интервалом.",
  editorVoiceVolume: "Громкость голоса",
  editorVoiceVolumeHelp: "Настраивается отдельно от сигналов интервалов.",
  editorPreviewSound: "Проверить сигнал",
  editorPreviewVoice: "Проверить голос",
  ...
  workoutPrepare: "Подготовка",
  workoutNow: "Сейчас",
  workoutFirst: "Сначала",
  workoutNext: "Дальше",
  workoutGetReady: "Приготовьтесь к следующему упражнению.",
  workoutStartingSoon: "Первый интервал начнётся через несколько секунд.",
  workoutSeconds: "сек",
  workoutPause: "Пауза",
  ...
  landingSignalsBody: "У упражнений и отдыха разные отчётливые сигналы. Во время перерыва английский голос называет следующее движение. Звук и голос настраиваются отдельно.",
  ...
  landingInstallTitle: "Установка приложения",
  landingInstallIntro: "Выберите свой браузер. Названия пунктов могут немного отличаться между версиями.",
  landingInstallRecommended: "Ваш браузер",
  landingInstallIOSSafari: "Safari на iPhone или iPad",
  landingInstallIOSStepOne: "Откройте эту страницу в Safari.",
  landingInstallIOSStepTwo: "Нажмите «Поделиться» на панели. Прокрутите меню и выберите «На экран Домой».",
  landingInstallIOSStepThree: "Включите «Открывать как веб-приложение» и нажмите «Добавить».",
  landingInstallAndroidChrome: "Chrome на Android",
  landingInstallChromeStepOne: "Нажмите ⋮ рядом с адресной строкой.",
  landingInstallChromeStepTwo: "Выберите «Добавить на главный экран», затем «Установить».",
  landingInstallAndroidFirefox: "Firefox на Android",
  landingInstallFirefoxStepOne: "Нажмите ⋮ на панели браузера.",
  landingInstallFirefoxStepTwo: "Выберите «Установить» и добавьте значок на главный экран.",
  landingInstallDesktopChromium: "Chrome или Edge на компьютере",
  landingInstallDesktopChromiumStepOne: "Нажмите значок установки в правой части адресной строки.",
  landingInstallDesktopChromiumStepTwo: "В Edge откройте меню ⋯, выберите «Приложения», затем «Установить этот сайт как приложение».",
  landingInstallDesktopFirefox: "Firefox или Zen на компьютере",
  landingInstallDesktopFirefoxStepOne: "В Firefox 143 или новее на Windows нажмите значок веб-приложения в адресной строке.",
  landingInstallDesktopFirefoxStepTwo: "В Zen и Firefox на macOS или Linux установка может быть недоступна. Откройте страницу в Chrome или Edge либо продолжите в браузере.",
  landingOpenWithoutInstall: "Открыть без установки",
  createdBy: "Создано",
  repositoryLinkLabel: "Исходный код на GitHub",
  ...
  privacyLocalBody: "Порядок упражнений, включённые упражнения, настройки звука и голоса, язык и история тренировок хранятся в браузере. Браузер также сохраняет файлы приложения, чтобы тренировка работала офлайн.",
